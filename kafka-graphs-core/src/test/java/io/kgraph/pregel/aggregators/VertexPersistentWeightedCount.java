...
public class VertexPersistentWeightedCount<K, EV> extends PregelGraphAlgorithm<K, Long, EV, Long> {
    ...
    public VertexPersistentWeightedCount(
        String hostAndPort,
        ...
        registerAggregator(VERTEX_COUNT_AGGREGATOR, LongSumAggregator.class, true);
    }

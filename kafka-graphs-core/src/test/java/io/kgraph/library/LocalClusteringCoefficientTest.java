...
public class LocalClusteringCoefficientTest extends AbstractIntegrationTest {
    private static final Logger log = LoggerFactory.getLogger(LocalClusteringCoefficientTest.class);

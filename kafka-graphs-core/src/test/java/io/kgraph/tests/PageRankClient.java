...
public class PageRankClient extends PageRankUtil {
    ...
    public PageRankClient(final Properties streamsProperties) {
        super();
    ...
    private static Properties getStreamsConfig(final Properties props) {
        ...
        fullProps.put(StreamsConfig.APPLICATION_ID_CONFIG, "PageRankSystemTest");
    ...
    private static KafkaStreams createKafkaStreams(final Properties props) {
        ...
        data.process(printProcessorSupplier("data"));
        ...
        minTable.toStream().process(printProcessorSupplier("min"));
        ...
        maxTable.toStream().process(printProcessorSupplier("max"));
        ...
        sumTable.toStream().process(printProcessorSupplier("sum"));
        ...
        cntTable.toStream().process(printProcessorSupplier("cnt"));

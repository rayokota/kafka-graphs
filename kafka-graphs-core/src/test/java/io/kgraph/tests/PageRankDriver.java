...
public class PageRankDriver extends PageRankUtil {
    ...
    public static Map<String, Set<Integer>> generate(final String kafka,
        ...
        producerProps.put(ProducerConfig.CLIENT_ID_CONFIG, "PageRankSystemTest");
